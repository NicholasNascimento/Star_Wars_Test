...
export function UserProvider({children}: UserContextProps) {
  ...
  async function search(charName: string) {
    try {
      ...
      const peopleDataPage2 = await api.get(`${characterData.data.people}?page=2&search=&format=json`);
      const peopleDataPage3 = await api.get(`${characterData.data.people}?page=3&search=&format=json`);
      const peopleDataPage4 = await api.get(`${characterData.data.people}?page=4&search=&format=json`);
      const peopleDataPage5 = await api.get(`${characterData.data.people}?page=5&search=&format=json`);
      const peopleDataPage6 = await api.get(`${characterData.data.people}?page=6&search=&format=json`);
      const peopleDataPage7 = await api.get(`${characterData.data.people}?page=7&search=&format=json`);
      const peopleDataPage8 = await api.get(`${characterData.data.people}?page=8&search=&format=json`);
      const peopleDataPage9 = await api.get(`${characterData.data.people}?page=9&search=&format=json`);
      const planetsData = await api.get(`${characterData.data.planets}?search=&format=json`);
      const planetsData2 = await api.get(`${characterData.data.planets}?page=2&search=&format=json`);
      const planetsData3 = await api.get(`${characterData.data.planets}?page=3&search=&format=json`);
      const planetsData4 = await api.get(`${characterData.data.planets}?page=4&search=&format=json`);
      const planetsData5 = await api.get(`${characterData.data.planets}?page=5&search=&format=json`);
      const planetsData6 = await api.get(`${characterData.data.planets}?page=6&search=&format=json`);
      const planetsData7 = await api.get(`${characterData.data.planets}?page=7&search=&format=json`);
      ...
      const speciesData2 = await api.get(`${characterData.data.species}?page=2&search=&format=json`);
      const speciesData3 = await api.get(`${characterData.data.species}?page=3&search=&format=json`);
      const speciesData4 = await api.get(`${characterData.data.species}?page=4&search=&format=json`);
      const vehiclesData = await api.get(`${characterData.data.vehicles}?search=&format=json`);
      const vehiclesData2 = await api.get(`${characterData.data.vehicles}?page=2&search=&format=json`);
      const vehiclesData3 = await api.get(`${characterData.data.vehicles}?page=3&search=&format=json`);
      const vehiclesData4 = await api.get(`${characterData.data.vehicles}?page=4&search=&format=json`);
      const starshipsData = await api.get(`${characterData.data.starships}?search=&format=json`);
      const starshipsData2 = await api.get(`${characterData.data.starships}?page=2&search=&format=json`);
      const starshipsData3 = await api.get(`${characterData.data.starships}?page=3&search=&format=json`);
      const starshipsData4 = await api.get(`${characterData.data.starships}?page=4&search=&format=json`);
